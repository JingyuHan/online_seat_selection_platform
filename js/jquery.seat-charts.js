...
function getseat(lable){
	...
	switch (true){case lable<22:seat="1_" + (43-2*lable);break;case lable<43:seat="1_" + (2*lable-42);break;case lable<65:seat="2_" + (129-2*lable);break;case lable<87:seat="2_" + (2*lable-128);break;
			...
			case lable<628:seat="13_" + (1255-2*lable);break;case lable<655:seat="13_" + (2*lable-1254);break;case lable<681:seat="14_" + (1361-2*lable);break;default:seat="14_" + (2*lable-1360);break;
		}
return seat;}
(function($) {
			...
			seat = (function(seatCharts, seatChartsSettings) {
				return function (setup) {
					...
					fn.settings.$node
						...
						.text(getseat(fn.settings.label).split("_")[1])
